...
class ShoesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shoe" do
    assert_difference('Shoe.count') do
      post shoes_url, params: { shoe: { price: @shoe.price, quantity: @shoe.quantity, size: @shoe.size, sku: @shoe.sku} }
    end
  ...
  test "should update shoe" do
    patch shoe_url(@shoe), params: { shoe: { price: @shoe.price, quantity: @shoe.quantity, size: @shoe.size, sku: @shoe.sku} }
